...
import ca.tklab.core.springoveride.facebook.MptFacebookConnectionFactory;
import ca.tklab.secret.web.secret.SimpleSignInAdapter;
import ca.tklab.secret.web.social.facebook.PostToWallAfterConnectInterceptor;
import ca.tklab.secret.web.social.twitter.TweetAfterConnectInterceptor;
...
//		cfConfig.addConnectionFactory(new FacebookConnectionFactory(appKey, appSecret));
		cfConfig.addConnectionFactory(new MptFacebookConnectionFactory(appKey, appSecret));
